...
const TableNameTLinkAccessLog = "t_link_access_logs"

// TLinkAccessLog mapped from table <t_link_access_logs>
...
// TableName TLinkAccessLog's table name
func (*TLinkAccessLog) TableName() string {
	return TableNameTLinkAccessLog
}
