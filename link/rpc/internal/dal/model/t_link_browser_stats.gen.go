...
const TableNameTLinkBrowserStat = "t_link_browser_stats"

// TLinkBrowserStat mapped from table <t_link_browser_stats>
...
// TableName TLinkBrowserStat's table name
func (*TLinkBrowserStat) TableName() string {
	return TableNameTLinkBrowserStat
}
