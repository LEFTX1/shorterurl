...
const TableNameTLinkDeviceStat = "t_link_device_stats"

// TLinkDeviceStat mapped from table <t_link_device_stats>
...
// TableName TLinkDeviceStat's table name
func (*TLinkDeviceStat) TableName() string {
	return TableNameTLinkDeviceStat
}
