...
type RpcRegisterLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewRpcRegisterLogic(ctx context.Context, svcCtx *svc.ServiceContext) *RpcRegisterLogic {
	return &RpcRegisterLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
// 用户注册
func (l *RpcRegisterLogic) RpcRegister(in *user.RegisterRequest) (*user.RegisterResponse, error) {
	// 1. 检查布隆过滤器中是否存在该用户名
